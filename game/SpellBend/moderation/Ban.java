...
public class Ban extends Punishment {
    ...
    public static @NotNull Ban deserialize(@NotNull Map<String, Object> map) {
        return new Ban(new TimeSpan(new Date((long) map.get("startDate")), new Date((long) map.get("endDate"))), Enums.Rule.valueOf((String) map.get("rule")), (String) map.get("reason"));
    }
}